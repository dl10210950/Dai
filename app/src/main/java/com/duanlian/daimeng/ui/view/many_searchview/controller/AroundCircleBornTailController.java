package com.duanlian.daimeng.ui.view.many_searchview.controller;
 ...
 */
public class AroundCircleBornTailController extends BaseController {
    ...
    public AroundCircleBornTailController() {
        mRectF = new RectF();
    }
