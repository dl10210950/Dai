package com.duanlian.daimeng.ui.view.shinebutton;
...
public class ShineView extends View {
    ...
    public static class ShineParams {
        ShineParams() {
            colorRandom[0] = Color.parseColor("#FF0000");
            colorRandom[1] = Color.parseColor("#C71585");
            colorRandom[2] = Color.parseColor("#800080");
            colorRandom[3] = Color.parseColor("#40e0d0");
            colorRandom[4] = Color.parseColor("#00ff00");
            colorRandom[5] = Color.parseColor("#dc143c");
            colorRandom[6] = Color.parseColor("#c71585");
            colorRandom[7] = Color.parseColor("#7fffd4");
            colorRandom[8] = Color.parseColor("#00ffff");
            colorRandom[9] = Color.parseColor("#f08080");
        }
