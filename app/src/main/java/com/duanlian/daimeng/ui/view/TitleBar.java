...
public class TitleBar extends LinearLayout {
    ...
    private void initLeftView() {
        ...
        mLeftImageButton = (ImageButton) mleftImageButtonView.findViewById(R.id.ib_titlebar_left);
        mLeftImageButton.setImageResource(R.mipmap.ic_launcher);
    }
    ...
    private void initRightView() {
        ...
        mRightImageButton = (ImageButton) mRightImageButtonView.findViewById(R.id.ib_titlebar_right);
    }
